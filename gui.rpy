...
## questo file vengano eseguite prima di quelle di inizializzazione in qualsiasi
## altro file.
init offset = -2
...
## Abilita i controlli per proprietà non valide o instabili nelle schermate o
...
## miniatura, e testo che riporta i contenuti dello slot. Uno slot di
## salvataggio usa immagini presenti in gui/button, come tutti gli altri tipi di
## pulsante.

## Il pulsante slot salvataggio.
...
## Larghezza e altezza delle miniature usate dallo slot di salvataggio.
define config.thumbnail_width = 384
define config.thumbnail_height = 216

## Numero di colonne e righe della griglia degli slot di salvataggio.
...
##
## L'interfaccia grafica predefinita usa solo cursori e barre di scorrimento
## verticali. Tutte le altre barre sono utilizzate solo in schermate scritte dai
## creatori di giochi.
...
init python:
    ...
    def small():
        ...
        ## Cambia dimensione e spaziatura di vari elementi.
        gui.slider_size = 54
