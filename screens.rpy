...
##
## La schermata dei dialoghi (say) è usata per mostrare dialoghi al giocatore.
## Richiede due parametri, who e what, che sono il nome del personaggio che
## parla e il testo da mostrare. (Il parametro who può essere None se non si
## intende fornire un nome)
##
## Questa schermata crea un displayable di testo con id "what", che Ren'Py usa
## per gestire la visualizzazione del testo. Può creare anche displayable con id
...
## Rendi la casella dei nomi disponibile per lo styling attraverso l'oggetto
## Character.
init python:
...
##
## Questa schermata si usa per mostrare renpy.input. Il parametro prompt è usato
## per fornire un prompt testuale.
##
## Questa schermata deve creare un displayable input con id "input" per
## accettare i vari parametri dell'input.
##
...
## Schermata di scelta #########################################################
##
## Questa schermata è usata per mostrare le scelte nel gioco, offerte dal
## comando 'menu'. Il solo parametro, 'items', è una lista di oggetti, ciascuna
## coi campi 'caption' e 'action'.
##
...
##
## Il menu rapido è mostrato durante il gioco per fornire accesso facile ai menu
## esterni.
...
##
## Questa schermata è inclusa nei menu principale e di gioco, e consente di
## navigare verso altri menu o di iniziare il gioco.
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            ## L'Aiuto non è necessario o rilevante sui dispositivi mobili.
...
##
## Usato per mostrare il menu principale quando si avvia Ren'Py.
##
...
screen main_menu():
    ...
    ## Il comando 'use' include un'altra schermata all'interno della corrente.
    ## I contenuti effettivi del menu principale sono nella schermata di
    ## navigazione.
    use navigation
...
##
## Costituisce la struttura comune di qualunque schermata del menu di gioco.
## Viene avviato nella schermata del titolo, e mostra lo sfondo, il titolo e la
## navigazione.
##
## Il parametro 'scroll' può essere None, oppure uno fra "viewport" o "vpgrid".
## Questa schermata è progettata per essere usata con uno o più figli, che sono
...
##
## Questa schermata visualizza i crediti e le informazioni di copyright sul
## gioco e su Ren'Py.
##
## Non c'è niente di speciale in questa schermata, pertanto può servire come
## esempio su come si crea una schermata personalizzata.

screen about():

    tag menu

    ## Questo comando 'use' include la schermata game_menu all'interno della
    ## corrente. Il figlio di vbox è quindi incluso nel viewport all'interno
    ## dello screen game_menu. 
            ...
            vbox:
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("Carica dati per la Sincronizzazione"):
                            action UploadSync()
                            xalign 0.5
                    else:
                        textbutton _("Scarica dati Sincronizzati"):
                            action DownloadSync()
                            xalign 0.5
...
screen keyboard_help():
    ...
    hbox:
        label _("Invio")
        text _("Avanza nei dialoghi e conferma opzioni.")
    ...
    hbox:
        label "H"
        text _("Nascondi l'interfaccia utente.")
    ...
    hbox:
        label "Shift+A"
        text _("Apri il menu di accessibilità.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Dorsale Destro")
        text _("Procedi fino all'ultimo dialogo letto.")

    hbox:
        label _("Croce direzionale, Joystick")
        text _("Naviga nell'interfaccia.")
...
##
## La schermata di conferma (confirm) è usata quando Ren'Py vuole porre una
## domanda 'sì o no?' al giocatore.
##
...
##
## La schermata skip_indicator è visualizzata per indicare che è in corso la
## modalità salto.
##
...
style skip_triangle:
    ## Bisogna usare un carattere che contenga il glifo BLACK RIGHT-POINTING
    ## SMALL TRIANGLE.
    font "DejaVuSans.ttf"
...
##
## La schermata di notifica (notify) è usata per mostrare una notifica al
## giocatore (per esempio, quando si salva rapidamente o si cattura una
## schermata).
##
...
## Schermata NVL ###############################################################
##
## Questa schermata è usata per dialoghi e menu in modalità NVL.
##
...
## Schermata a bolle ###########################################################
##
## La schermata a bolle (bubble) è usata per visualizzare il dialogo al
## giocatore quando si usano le bolle di dialogo. La schermata a bolle prende
## gli stessi parametri della schermata say, deve creare un visualizzabile
## con l'id "what" e può creare visualizzabili con gli id "namebox", "who" e
## "window".
##
